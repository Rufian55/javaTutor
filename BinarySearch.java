...
public class BinarySearch {
	...
	public static void main(String []args){
		...
		if(sought4 < 0)// If seekThis is negative, it's the bitwise not of insert the point.
			System.out.println("\nSought value \"" + seekThis + "\" not found.\n"
					+ "Insertion point is anArray[" + (-(sought4)-1) + "]");
		else
			System.out.println("\n" + seekThis + " was found at anArray[" + sought4 + "]");

		if(seekThat < 0)// If seekThat is negative, it's the bitwise not of the insert the point.
